...
class Branch(Command):
    ...
    # How much "energy" this branch inherently creates or consumes
    # per tick, not taking into account any children.
    #
    # "Energy" is analogous to energy derived from photosynthesis
    # -- energy generated by leaves. Energy is generally shared
    # globally across the entire tree. If we have surplus energy,
    # some random branch gets the benefit of it.
    #
    # If this quantity is negative, this "branch" consumes energy.
    # If it's positive, it generates energy.
    energy: float = 1.0

    # How many "nutrients" this branch inherently creates or consumes
    # per tick, not taking into account any children.
    #
    # "Nutrients" is analogous to nutrients we gain from the ground.
    # Nutrients are consumed first by the lowermost branches.
    #
    # TODO
    #nutrients: float = 1.0
